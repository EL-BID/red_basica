...
class CriteriaDataMapper(QDataWidgetMapper):
    ...
    def map(self, ui):
        ...
        self.addMapping(ui.diameterUp150SpinBox, model.fieldIndex('diameter_up_150'))
        self.addMapping(ui.diameterUp200SpinBox, model.fieldIndex('diameter_up_200'))
        self.addMapping(ui.diameterUp250SpinBox, model.fieldIndex('from_diameter_250'))
        self.addMapping(ui.coverMinStreetSpinBox, model.fieldIndex('cover_min_street'))
        self.addMapping(ui.coverMinSidewalksGsSpinBox, model.fieldIndex('cover_min_sidewalks_gs'))
        self.addMapping(ui.typePreferredHeadColSpinBox, model.fieldIndex('type_preferred_head_col'))
        self.addMapping(ui.maxDropSpinBox, model.fieldIndex('max_drop'))
        self.addMapping(ui.bottomIbMhSpinBox, model.fieldIndex('bottom_ib_mh'))