...
<qgis version="2.18.0" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="ID_TRM_(N)"/>
  ...
  <attributeactions default="0">
    <actionsetting showInAttributeTable="1" action="echo &quot;[% &quot;MY_FIELD&quot; %]&quot;" icon="" capture="1" type="0" name="Eco do valor de atributo" shortTitle=""/>
    <actionsetting showInAttributeTable="1" action="ogr2ogr -f &quot;ESRI Shapefile&quot; &quot;[% &quot;OUTPUT_PATH&quot; %]&quot; &quot;[% &quot;INPUT_FILE&quot; %]&quot;" icon="" capture="1" type="0" name="Rodar aplicação" shortTitle=""/>
    <actionsetting showInAttributeTable="1" action="QtGui.QMessageBox.information(None, &quot;Feature id&quot;, &quot;feature id is [% $id %]&quot;)" icon="" capture="0" type="1" name="Obter feição id" shortTitle=""/>
    <actionsetting showInAttributeTable="1" action="QtGui.QMessageBox.information(None, &quot;Current field's value&quot;, &quot;[% $currentfield %]&quot;)" icon="" capture="0" type="1" name="Selecionar valores de campo (Identificar ferramentas de identificação)" shortTitle=""/>
    <actionsetting showInAttributeTable="1" action="QtGui.QMessageBox.information(None, &quot;Clicked coords&quot;, &quot;layer: [% $layerid %]\ncoords: ([% $clickx %],[% $clicky %])&quot;)" icon="" capture="0" type="1" name="Coordenadas clicadas (Rodar ferramentas de ações de feições)" shortTitle=""/>
    <actionsetting showInAttributeTable="1" action="[% &quot;PATH&quot; %]" icon="" capture="0" type="5" name="Abrir arquivo" shortTitle=""/>
    <actionsetting showInAttributeTable="1" action="http://www.google.com/search?q=[% &quot;ATTRIBUTE&quot; %]" icon="" capture="0" type="5" name="Buscar na web valores de atributo" shortTitle=""/>
  </attributeactions>
